...
namespace Lygl.DalLib.UserManager
{
    ...
    /// <summary>
    /// RolePermission (editable child object).<br/>
    /// This is a generated base class of <see cref="RolePermission"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="RolePermissionList"/> collection.
    /// </remarks>
    [Serializable]
    public partial class RolePermission : BusinessBase<RolePermission>
    {
        ...
        /// <summary>
        /// Loads default values for the <see cref="RolePermission"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="RolePermission"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="RolePermission"/> object in the database.
        /// </summary>
        ...
        private void Child_Insert(Role parent)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.AddRolePermission", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="RolePermission"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("LyglDB"))
            {
                using (var cmd = new SqlCommand("dbo.UpdateRolePermission", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Name", ReadProperty(NameProperty)).DbType = DbType.String;
        ...
        /// <summary>
        /// Self deletes the <see cref="RolePermission"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("LyglDB"))
            {
                using (var cmd = new SqlCommand("dbo.DeleteRolePermission", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@PermissionID", ReadProperty(PermissionIDProperty)).DbType = DbType.Guid;
