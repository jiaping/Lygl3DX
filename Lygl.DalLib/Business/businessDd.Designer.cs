...
namespace Lygl.DalLib.Business
{
    ...
    /// <summary>
    /// BusinessDd (editable child object).<br/>
    /// This is a generated base class of <see cref="BusinessDd"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="BusinessDdList"/> collection.
    /// </remarks>
    [Serializable]
    public partial class BusinessDd : BusinessBase<BusinessDd>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessDd"/> class.
        /// </summary>
        ...
        protected override void AddBusinessRules()
        {
            ...
            // StartDate
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(StartDateProperty));
            // EndDate
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(EndDateProperty));
        ...
        /// <summary>
        /// Loads default values for the <see cref="BusinessDd"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="BusinessDd"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="BusinessDd"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("LyglDB"))
            {
                using (var cmd = new SqlCommand("dbo.AddBusinessDd", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="BusinessDd"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("LyglDB"))
            {
                using (var cmd = new SqlCommand("dbo.UpdateBusinessDd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@BusinessID", ReadProperty(BusinessIDProperty)).DbType = DbType.Guid;
        ...
        /// <summary>
        /// Self deletes the <see cref="BusinessDd"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("LyglDB"))
            {
                using (var cmd = new SqlCommand("dbo.DeleteBusinessDd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@BusinessID", ReadProperty(BusinessIDProperty)).DbType = DbType.Guid;
