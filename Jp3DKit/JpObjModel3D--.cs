...
namespace Jp3DKit
{
    ...
    public class JpObjModel3D : GeometryModel3D
    {
        ...
        protected EffectScalarVariable bHasInstances, bHasDiffuseMapVariable;
        protected EffectShaderResourceVariable texDiffuseMapVariable;
        ...
        private void SetTechniqueAndMaterial(AttributeRage item)
        {
            ...
            //this.effectMaterial.vMaterialDiffuseVariable.Set( new Vector4(material.vDiffuse, this.Alpha));
            ...
            {
                this.texDiffuseMapVariable.SetResource(null);
                this.bHasDiffuseMapVariable.Set(false);
            }
            else
            {
                this.texDiffuseMapVariable.SetResource(material.TextrueMap);
                this.bHasDiffuseMapVariable.Set(true);
            }
            //    /// --- render the geometry
