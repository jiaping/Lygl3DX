...
namespace Lygl.UI.Framework.Controls
{
    /// <summary>
    /// 本程序参考于
    ...
    public static class Masking
    {
        ...
        public static readonly DependencyProperty Empty2ZeroProperty = DependencyProperty.RegisterAttached("Empty2Zero",
                typeof(bool),
                typeof(Masking));
        ...
        public static bool GetEmpty2Zero(TextBox textBox)
        {
            if (textBox == null)
            {
                throw new ArgumentNullException("textBox");
            }
            string temp=textBox.GetValue(Empty2ZeroProperty) as string;
            bool val;
           bool result=bool.TryParse(temp,out val) ;
           if (result)
               return val;
           else return false;
        }

        public static void SetEmpty2Zero(TextBox textBox, bool empty2Zero)
        {
            if (textBox == null)
            {
                throw new ArgumentNullException("textBox");
            ...
            textBox.SetValue(Empty2ZeroProperty, empty2Zero);
        }
